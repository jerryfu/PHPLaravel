(function (a) {
    a.fn.mask = function (c, b) {
        a(this).each(function () {
            if (b !== undefined && b > 0) {
                var d = a(this);
                d.data("_mask_timeout", setTimeout(function () { a.maskElement(d, c); }, b));
            }
            else {
    ...
    a.fn.unmask = function () { a(this).each(function () { a.unmaskElement(a(this)); }); };
    a.fn.isMasked = function () { return this.hasClass("masked"); };
