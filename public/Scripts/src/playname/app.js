                ...
                React.createElement("thead", null,
                    React.createElement("tr", null,
                        ...
                        React.createElement("th", null,
                            React.createElement(OrderButton_1.default, { title: "年度", field: 'yy', sort: pp.page_grid.sort, now_field: pp.page_grid.field, setSort: this.setSort })),
                        React.createElement("th", { className: "text-left" },
                            React.createElement(OrderButton_1.default, { title: "賽名", field: 'play_name', sort: pp.page_grid.sort, now_field: pp.page_grid.field, setSort: this.setSort })))),
                React.createElement("tbody", null,
                    row_data.map((item, i) => {
                        return React.createElement("tr", { key: item.playname_id },
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-danger oi", title: lang.delete, dataGlyph: "trash", onClick: this.callRemove.bind(this, item.playname_id) })),
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-success oi", title: lang.modify, dataGlyph: "pencil", onClick: this.callEdit.bind(this, item.playname_id) })),
                            React.createElement("td", null, item.yy),
            ...
            React.createElement("form", { className: "form-list", onSubmit: this.submit },
                React.createElement("dl", { className: "field" },
                    ...
                    React.createElement("dd", { className: "col-5" },
                        React.createElement(components_1.InputNum, { id: 'yy', ref: 'yy', onChange: this.chgFldVal.bind(this, 'yy'), value: pp.field.yy, required: true, onlyPositive: true }))),
                React.createElement("dl", { className: "field" },
                    React.createElement("dt", { className: "col-2" }, "\u8CFD\u540D"),
                    React.createElement("dd", { className: "col-5" },
                        React.createElement(components_1.InputText, { onChange: this.chgFldVal.bind(this, 'play_name'), value: pp.field.play_name, required: false, maxLength: 60 }))),
