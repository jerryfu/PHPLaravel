                ...
                React.createElement("thead", null,
                    React.createElement("tr", null,
                        ...
                        React.createElement("th", { className: "text-left" },
                            React.createElement(OrderButton_1.default, { title: "名稱", field: 'title', sort: pp.page_grid.sort, now_field: pp.page_grid.field, setSort: this.setSort })),
                        React.createElement("th", null,
                            React.createElement(OrderButton_1.default, { title: "發佈日期", field: 'set_date', sort: pp.page_grid.sort, now_field: pp.page_grid.field, setSort: this.setSort })),
                        React.createElement("th", null,
                        ...
                        React.createElement("th", null,
                            React.createElement(OrderButton_1.default, { title: "前台顯示", field: 'state', sort: pp.page_grid.sort, now_field: pp.page_grid.field, setSort: this.setSort })))),
                React.createElement("tbody", null,
                    row_data.map((item, i) => {
                        return React.createElement("tr", { key: item.album_id },
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-danger oi", title: lang.delete, dataGlyph: "trash", onClick: this.callRemove.bind(this, item.album_id) })),
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-success oi", title: lang.modify, dataGlyph: "pencil", onClick: this.callEdit.bind(this, item.album_id) })),
                            React.createElement("td", { className: "text-left" }, item.title),
                            React.createElement("td", null, comm_func_1.stdDate(item.set_date)),
...
class Edit extends React.Component {
    ...
    submit(e) {
        e.preventDefault();
        let id = this.props.field.album_id;
            ...
            React.createElement("form", { className: "form-list", onSubmit: this.submit },
                React.createElement("dl", { className: "field" },
                    ...
                    React.createElement("dd", { className: "col-9" },
                        React.createElement(com_datepick_1.DatePickText, { inputClassName: "form-element", inputViewMode: 1, onChange: this.chgFldVal.bind(this, 'set_date'), value: pp.field.set_date }))),
                React.createElement("dl", { className: "field" },
                    React.createElement("dt", { className: "col-2" }, "\u540D\u7A31"),
                    React.createElement("dd", { className: "col-9" },
                        React.createElement(components_1.InputText, { onChange: this.chgFldVal.bind(this, 'title'), value: pp.field.title, required: true, maxLength: 64 }))),
                React.createElement("dl", { className: "field" },
                    React.createElement("dt", { className: "col-2" }, "\u8D85\u9023\u7D50"),
                    React.createElement("dd", { className: "col-9" },
                        React.createElement(components_1.InputText, { onChange: this.chgFldVal.bind(this, 'url'), value: pp.field.url, required: true, maxLength: 1000 }))),
                React.createElement("dl", { className: "field" },
                    React.createElement("dt", { className: "col-2" }, "\u7C21\u4ECB"),
                    React.createElement("dd", { className: "col-9" },
                        React.createElement(components_1.AreaText, { onChange: this.chgFldVal.bind(this, 'context'), value: pp.field.context, required: true, maxLength: 45, rows: 4 }),
                        React.createElement("small", { className: "text-danger" }, "* \u4E0D\u8D85\u904E45\u500B\u5B57"))),
                React.createElement("dl", { className: "field" },
                    React.createElement("dt", { className: "col-2" }, "\u5217\u8868\u5716"),
                    React.createElement("dd", { className: "col-5" }, pp.edit_type == 2 ? React.createElement(components_1.FileUpBtn, { id: pp.field.album_id, fileKey: "album_list", title: "圖片上傳", is_img: true })
                ...
                React.createElement("dl", { className: "field" },
                    ...
                    React.createElement("dd", { className: "col-5" },
                        React.createElement(components_1.InputNum, { onChange: this.chgFldVal.bind(this, 'sort'), value: pp.field.sort, required: true }),
                        React.createElement("small", null, "\u6578\u5B57\u6108\u5927\u6108\u524D\u9762"))),
                React.createElement("dl", { className: "field" },
                    React.createElement("dt", { className: "col-2" }, "\u524D\u53F0\u986F\u793A"),
                    React.createElement("dd", { className: "col-5" },
