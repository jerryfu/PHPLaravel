...
function callLoad(p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let pm = {};
        let data = yield ajax_1.ft(api_1.default.GET__api_PlayDivide, pm);
...
function callEdit(id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let data = yield ajax_1.ft(api_1.default.GET__api_PlayDivide_Item, pm);
        vwMaskLoading_1.mask_off();
        if (data.state > 0) {
            alert(data.message);
            return;
...
function callRemove(id, p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let tm = { id };
        let pm = dopack_1.doWKPA(tm);
        let data = yield ajax_1.ft(api_1.default.POST__api_PlayDivide_Remove, pm);
        vwMaskLoading_1.mask_off();
        if (data.state > 0) {
...
function submitData(id, edit_type, data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let pm = dopack_1.doWKPA(tm);
        if (edit_type == 2) {
            let data = yield ajax_1.ft(api_1.default.POST__api_PlayDivide_Update, pm);
            ...
            let data = yield ajax_1.ft(api_1.default.POST__api_PlayDivide, pm);
            if (data.state == defData_1.err_code.HasErrList) {
                let err_message = comm_func_1.packegeErrList(data.err_list);
                comm_func_1.tosMessage('', err_message, 3);
            }
...
function editTeam(play_divide_id) {
    return __awaiter(this, void 0, void 0, function* () {
        var data = yield ajax_1.ft(api_1.default.GET__api_PlayDivideTeam, { play_divide_id });
        let r = {
            type: exports.ac.editTeam,
            data: data.data,
            play_divide_id
        };
        return r;
...
exports.submitTeam = submitTeam;
function setSelectTeam(data) {
    return {
        type: exports.ac.setSelectTeam,
        data
    };
}
exports.setSelectTeam = setSelectTeam;
function sortTeam(data) {
    return {
        type: exports.ac.sortTeam,
        data
    };
}
exports.sortTeam = sortTeam;
function sortRedo(data) {
    return {
        type: exports.ac.sortTeam,
        data
    };
}
exports.sortRedo = sortRedo;
...
const set_play_team = (state = {}, action) => {
    switch (action.type) {
        case exports.ac.editTeam:
            return action.data;
        case exports.ac.setSelectTeam:
            return action.data;
        case exports.ac.sortTeam:
            return action.data;
        case exports.ac.sortRedo:
            return action.data;
        default:
            return state;
    }
};
exports.store = cbnReduce_1.default({ menudata: reducers_1.menudata, oper_id, search, page_grid, edit_type, view_mode, field, kfield, exist, set_play_team });
