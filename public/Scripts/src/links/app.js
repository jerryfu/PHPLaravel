        ...
        out_html = React.createElement("div", { style: { display: show } },
            ...
            React.createElement("table", { className: "table-list table-hover table-striped" },
                ...
                React.createElement("tbody", null,
                    row_data.map((item, i) => {
                        return React.createElement("tr", { key: item.links_id },
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-danger oi", title: lang.delete, dataGlyph: "trash", onClick: this.callRemove.bind(this, item.links_id) })),
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-success oi", title: lang.modify, dataGlyph: "pencil", onClick: this.callEdit.bind(this, item.links_id) })),
            ...
            React.createElement("form", { className: "form-list", onSubmit: this.submit },
                ...
                React.createElement("dl", { className: "field" },
                    ...
                    React.createElement("dd", { className: "col-5" }, pp.edit_type == 2 ?
                        React.createElement(components_1.FileUpBtn, { id: pp.field.links_id, fileKey: "links_list", title: "圖片上傳", is_img: true })
