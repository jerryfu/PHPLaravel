        ...
        out_html = React.createElement("div", null,
            ...
            React.createElement("form", { className: "form-list", onSubmit: this.submit },
                React.createElement("nav", { className: "tab" },
                    React.createElement("a", { href: "#tab1", className: 'tab-nav' + (st.tab_index == 0 ? ' active' : ''), onClick: this.tabs.bind(this, 0) }, "\u6703\u54E1\u52A0\u5165\u8AAA\u660E"),
                    React.createElement("a", { href: "#tab2", className: 'tab-nav' + (st.tab_index == 1 ? ' active' : ''), onClick: this.tabs.bind(this, 1) }, "\u65B0\u6703\u54E1\u62BD\u734E\u8AAA\u660E"),
                    React.createElement("a", { href: "#tab3", className: 'tab-nav' + (st.tab_index == 2 ? ' active' : ''), onClick: this.tabs.bind(this, 2) }, "\u4E2D\u734E\u540D\u55AE")),
