...
class StatsPlayer extends React.Component {
    ...
    ajaxQuery() {
        ...
        ajax_1.ft(api_1.default.GET__api_Utility_GetStatsPlayer, params)
            .then((res) => {
    ...
    render() {
        ...
        return React.createElement("div", null,
            React.createElement("form", { className: "wrap field mb-48" },
                ...
                React.createElement("input", { type: "text", className: "form-element w-20 mr-12", value: query.keyword, onChange: this.chgQuery.bind(this, 'keyword'), placeholder: "請輸入球員或球隊" }),
                    ...
                    React.createElement("table", { className: "table-line table-hover" },
                        React.createElement("thead", null,
                            React.createElement("tr", null,
                                React.createElement("th", { rowSpan: 2, className: "text-left" }, "\u7403\u54E1"),
                                React.createElement("th", { rowSpan: 2 }, "\u80CC\u865F"),
                                React.createElement("th", { rowSpan: 2, className: "text-left" }, "\u7403\u968A"),
                                ...
                                React.createElement("th", { rowSpan: 2 }, "\u52A9\u653B"),
                                React.createElement("th", { rowSpan: 2 }, "\u6284\u622A"),
                                React.createElement("th", { rowSpan: 2 }, "\u963B\u653B"),
                                React.createElement("th", { rowSpan: 2 }, "\u5931\u8AA4"),
                                React.createElement("th", { rowSpan: 2 }, "\u72AF\u898F"),
                                React.createElement("th", { rowSpan: 2 }, "\u5F97\u5206")),
                            React.createElement("tr", null,
                            ...
                            static_data.map((item, i) => {
                                ...
                                return React.createElement("tr", null,
                                    React.createElement("td", { className: "text-left" },
                                        React.createElement("a", { href: gb_approot + 'Player?id=' + item.player_id, className: "hover-danger" }, item.player_name)),
                                    ...
                                    React.createElement("td", { className: "text-right text-nowarp" }, item.Y2 ? item.Y2 : 0),
                                    ...
                                    React.createElement("td", { className: "text-right text-nowarp" },
                                        ...
                                        rate_b2 ? rate_b2 : 0,
                                        "%)"),
                                    React.createElement("td", { className: "text-right text-nowarp" }, item.Y3 ? item.Y3 : 0),
                                    React.createElement("td", { className: "text-nowarp" }, "-"),
                                    ...
                                    React.createElement("td", { className: "text-right text-nowarp" },
                                        ...
                                        rate_b3 ? rate_b3 : 0,
                                        "%)"),
                                    React.createElement("td", { className: "text-right text-nowarp" }, item.YP ? item.YP : 0),
                                    React.createElement("td", { className: "text-nowarp" }, "-"),
                                ...
                                static_data.map((item, i) => {
                                    ...
                                    return React.createElement("tr", null,
                                        ...
                                        React.createElement("td", { className: "text-right text-nowarp" },
                                            ...
                                            rate_bp,
                                            "%)"),
                                        React.createElement("td", { className: "text-right text-nowarp" }, comm_func_1.stdNumber(item.ARebounds / item.num, 2)),
