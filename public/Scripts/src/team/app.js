    ...
    render() {
        ...
        out_html = React.createElement("div", { style: { display: show } },
            ...
            React.createElement("header", { className: "table-head form-inline" },
                React.createElement(components_1.InputText, { inputClassName: "form-element", onChange: this.chgQryVal.bind(this, 'keyword'), value: pp.search.keyword, placeholder: "隊名" })),
                ...
                React.createElement("thead", null,
                    React.createElement("tr", null,
                        ...
                        React.createElement("th", null,
                            React.createElement(OrderButton_1.default, { title: "代碼", field: 'team_id', sort: pp.page_grid.sort, now_field: pp.page_grid.field, setSort: this.setSort })),
                        React.createElement("th", { className: "text-left" },
                            React.createElement(OrderButton_1.default, { title: "隊名", field: 'team_name', sort: pp.page_grid.sort, now_field: pp.page_grid.field, setSort: this.setSort })),
                        React.createElement("th", null, "\u72C0\u614B"))),
                React.createElement("tbody", null,
                    row_data.map((item, i) => {
                        return React.createElement("tr", { key: item.team_id },
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-danger oi", title: lang.delete, dataGlyph: "trash", onClick: this.callRemove.bind(this, item.team_id) })),
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-success oi", title: lang.modify, dataGlyph: "pencil", onClick: this.callEdit.bind(this, item.team_id) })),
                            React.createElement("td", null, item.team_id),
    ...
    render() {
        ...
        out_html = React.createElement("div", { style: { display: show } },
            React.createElement("h3", { className: "title" },
                ...
                " ",
                React.createElement("small", { className: "oi", "data-glyph": "tags" }, lang.edit)),
            React.createElement("form", { className: "form-list", onSubmit: this.submit },
                React.createElement("dl", { className: "field" },
                    React.createElement("dt", { className: "col-2" }, "\u968A\u540D"),
                    React.createElement("dd", { className: "col-5" },
                        React.createElement(components_1.InputText, { inputClassName: "form-element", onChange: this.chgFldVal.bind(this, 'team_name'), value: pp.field.team_name, required: true, maxLength: 30 }))),
                React.createElement("dl", { className: "field" },
                    ...
                    React.createElement("dd", { className: "col-5" },
                        ...
                        "\u505C\u6B62")),
                React.createElement("dl", { className: "field" },
                    React.createElement("dt", { className: "col-2" }, "\u7403\u968ALogo\u5716"),
                    React.createElement("dd", { className: "col-5" }, pp.edit_type == 2 ?
                        [React.createElement(components_1.FileUpBtn, { id: pp.field.team_id, fileKey: "teamlog", title: "球隊Log圖", is_img: true }),
                            React.createElement("small", { className: "text-danger" }, "\u80CC\u666F\u8ACB\u8A2D\u70BA\u900F\u660E")]
