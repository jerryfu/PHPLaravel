...
function callLoad(p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let pm = {};
        let data = yield ajax_1.ft(api_1.default.GET__api_Param, pm);
...
function submitData(data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(data, tm);
        let result = yield ajax_1.ft(api_1.default.POST__api_Param, pm);
        if (result.state == defData_1.err_code.HasErrList) {
            let err_message = comm_func_1.packegeErrList(result.err_list);
            ...
            return dispatch => {
                dispatch({ type: exports.ac.submitOK, field: result });
            };
        }
    });
}
...
exports.store = cbnReduce_1.default({ menudata: reducers_1.menudata, oper_id, search, web_param, edit_type, view_mode, exist });
