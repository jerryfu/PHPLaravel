        ...
        out_html = React.createElement("div", { style: { display: show } },
            ...
            React.createElement("table", { className: "table-list table-hover table-striped" },
                ...
                React.createElement("thead", null,
                    React.createElement("tr", null,
                        ...
                        React.createElement("th", { className: "text-left" },
                            React.createElement(OrderButton_1.default, { title: "標題", field: 'title', sort: pp.page_grid.sort, now_field: pp.page_grid.field, setSort: this.setSort })),
                ...
                React.createElement("tbody", null,
                    row_data.map((item, i) => {
                        return React.createElement("tr", { key: item.video_id },
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-danger oi", title: lang.delete, dataGlyph: "trash", onClick: this.callRemove.bind(this, item.video_id) })),
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-success oi", title: lang.modify, dataGlyph: "pencil", onClick: this.callEdit.bind(this, item.video_id) })),
...
class Edit extends React.Component {
    constructor() {
        ...
        this.chgContext = this.chgContext.bind(this);
        this.state = {
            option_prodkind: [],
        };
    }
    ...
    chgMyText(e) {
        ...
        console.log('check a', v);
    }
    submit(e) {
        e.preventDefault();
        let id = this.props.field.video_id;
            ...
            React.createElement("form", { className: "form-list", onSubmit: this.submit },
                React.createElement("dl", { className: "field" },
                    ...
                    React.createElement("dd", { className: "col-4" },
                        React.createElement(com_datepick_1.DatePickText, { inputViewMode: 1, onChange: this.chgFldVal.bind(this, 'day'), value: pp.field.day }))),
                React.createElement("dl", { className: "field" },
                ...
                React.createElement("dl", { className: "field" },
                    ...
                    React.createElement("dd", { className: "col-9" },
                        React.createElement(components_1.InputText, { onChange: this.chgFldVal.bind(this, 'url'), value: pp.field.url, required: true, maxLength: 2000 }),
                ...
                React.createElement("dl", { className: "field" },
                    ...
                    React.createElement("dd", { className: "col-5" }, pp.edit_type == 2 ?
                        React.createElement(components_1.FileUpBtn, { id: pp.field.video_id, fileKey: "video_list", title: "圖片上傳", is_img: true })
                ...
                React.createElement("fieldset", null,
                    ...
                    React.createElement(com_editor_1.default, { value: pp.field.context, onChange: this.chgFldVal.bind(this, 'context') })),
