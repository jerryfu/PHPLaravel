...
interface GridProps {
    ...
    menu_name?: string,
    callLoad?: Function,
    field?: server.ParamAboutUs,
    kfield?: server.ParamAboutUs
    ...
    render() {
        ...
        out_html = <div>
            ...
            <form className="form-list" onSubmit={this.submit}>
                <nav className="tab">
                    <a href="#tab1" className={'tab-nav' + (st.tab_index == 0 ? ' active' : '')} onClick={this.tabs.bind(this, 0)}>TSBA簡介</a>
                    <a href="#tab2" className={'tab-nav' + (st.tab_index == 1 ? ' active' : '')} onClick={this.tabs.bind(this, 1)}>競賽規程</a>
                    <a href="#tab3" className={'tab-nav' + (st.tab_index == 2 ? ' active' : '')} onClick={this.tabs.bind(this, 2)}>報名資訊</a>
                </nav>
