...
interface GridProps {
    ...
    edit_type?: IEditType,
    menu_name?: string,
    page_grid?: GridInfo<server.Sponsor>,
    callEdit?: Function,
    callRemove?: Function,
    callPage?: Function,
    callLoad?: Function,
        ...
        out_html = <div style={{ display: show }}>
            ...
            <table className="table-list table-hover table-striped">
                ...
                <tbody>
                    {
                        row_data.map((item, i) => {
                            return <tr key={item.sponsor_id}>
                                <td className="item-edit">
                                    <PWButton className="hover-danger oi" title={lang.delete} dataGlyph="trash" onClick={this.callRemove.bind(this, item.sponsor_id)}>
                                    </PWButton>
                                </td>
                                <td className="item-edit">
                                    <PWButton className="hover-success oi" title={lang.modify} dataGlyph="pencil" onClick={this.callEdit.bind(this, item.sponsor_id)}>
                                    </PWButton>
                                </td>
...
interface EditProps {
    edit_type?: IEditType
    field?: server.Sponsor
    kfield?: server.Sponsor
    exist?: boolean
    oper_id?: string
        ...
        out_html = <div style={{ display: show }}>
            ...
            <form className="form-list" onSubmit={this.submit}>
                ...
                <dl className="field">
                    ...
                    <dd className="col-9">
                        <AreaText
                            ...
                            rows={4}
                        />
                        <small className="text-danger">* 不超過30個字</small>
                    </dd>
                </dl>
                ...
                <dl className="field">
                    ...
                    <dd className="col-5">
                        {
                            pp.edit_type == IEditType.modify ? <FileUpBtn id={pp.field.sponsor_id} fileKey="sponsor_list" title="圖片上傳" is_img={true} />
