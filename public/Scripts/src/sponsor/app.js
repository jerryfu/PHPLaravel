        ...
        out_html = React.createElement("div", { style: { display: show } },
            ...
            React.createElement("table", { className: "table-list table-hover table-striped" },
                ...
                React.createElement("tbody", null,
                    row_data.map((item, i) => {
                        return React.createElement("tr", { key: item.sponsor_id },
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-danger oi", title: lang.delete, dataGlyph: "trash", onClick: this.callRemove.bind(this, item.sponsor_id) })),
                            React.createElement("td", { className: "item-edit" },
                                React.createElement(components_1.PWButton, { className: "hover-success oi", title: lang.modify, dataGlyph: "pencil", onClick: this.callEdit.bind(this, item.sponsor_id) })),
...
class Edit extends React.Component {
    ...
    submit(e) {
        e.preventDefault();
        let id = this.props.field.sponsor_id;
        ...
        out_html = React.createElement("div", { style: { display: show } },
            ...
            React.createElement("form", { className: "form-list", onSubmit: this.submit },
                ...
                React.createElement("dl", { className: "field" },
                    ...
                    React.createElement("dd", { className: "col-9" },
                        React.createElement(components_1.AreaText, { onChange: this.chgFldVal.bind(this, 'context'), value: pp.field.context, required: true, maxLength: 30, rows: 4 }),
                        React.createElement("small", { className: "text-danger" }, "* \u4E0D\u8D85\u904E30\u500B\u5B57"))),
                React.createElement("dl", { className: "field" },
                    React.createElement("dt", { className: "col-2" }, "\u5716\u7247"),
                    React.createElement("dd", { className: "col-5" }, pp.edit_type == 2 ? React.createElement(components_1.FileUpBtn, { id: pp.field.sponsor_id, fileKey: "sponsor_list", title: "圖片上傳", is_img: true })
