...
function a3() {
    class App extends React.Component {
        ...
        render() {
            return (React.createElement("div", { id: "drag-drop-basic", style: { background: '#eefeff', display: 'flex' } },
                React.createElement("div", { id: "source-container", style: { flex: 1 } },
                    React.createElement("div", { id: "drag-source", draggable: true, onDragStart: this.dragStart, onDrag: this.drag, style: {
                            width: '90px',
                            height: '90px',
                            borderRadius: '50%',
                            backgroundColor: 'steelblue'
                        } })),
                React.createElement("div", { id: "target-container", style: {
                        height: '90px', width: '90px',
                        background: '#ffeeee',
                        border: '2px solid #CCC',
                        flex: 1,
                        margin: '1rem'
                    }, onDrop: this.drop, onDragOver: this.dragover }, "Here")));
        }
    }
    var dom = document.getElementById('page_content');
    react_dom_1.render(React.createElement(App, null), dom);
}
function a1() {
    const ItemTypes = {
        BOX: 'box',
