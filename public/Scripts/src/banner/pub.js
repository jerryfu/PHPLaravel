...
function callLoad(p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let pm = {};
        let data = yield ajax_1.ft(api_1.default.GET__api_Banner, pm);
...
function callEdit(id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let data = yield ajax_1.ft(api_1.default.GET__api_Banner_Item, pm);
        vwMaskLoading_1.mask_off();
        if (data.state > 0) {
            alert(data.message);
            return;
...
function callRemove(id, p) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let tm = { id };
        let pm = dopack_1.doWKPA(tm);
        let data = yield ajax_1.ft(api_1.default.POST__api_Banner_Remove, pm);
        vwMaskLoading_1.mask_off();
        if (data.state > 0) {
...
function submitData(id, edit_type, data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let pm = dopack_1.doWKPA(tm);
        if (edit_type == 2) {
            let data = yield ajax_1.ft(api_1.default.POST__api_Banner_Update, pm);
            ...
            let data = yield ajax_1.ft(api_1.default.POST__api_Banner, pm);
            if (data.state == defData_1.err_code.HasErrList) {
                let err_message = comm_func_1.packegeErrList(data.err_list);
                comm_func_1.tosMessage('', err_message, 3);
            }
