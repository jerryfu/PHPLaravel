...
interface GridProps {
    ...
    edit_type?: IEditType,
    menu_name?: string,
    page_grid?: GridInfo<server.Banner>,
    callEdit?: Function,
    callRemove?: Function,
    callPage?: Function,
    callLoad?: Function,
        ...
        out_html = <div style={{ display: show }}>
            ...
            <table className="table-list table-hover table-striped">
                ...
                <tbody>
                    {
                        row_data.map((item, i) => {
                            return <tr key={item.banner_id}>
                                <td className="item-edit">
                                    <PWButton className="hover-danger oi" title={lang.delete} dataGlyph="trash" onClick={this.callRemove.bind(this, item.banner_id)}>
                                    </PWButton>
                                </td>
                                <td className="item-edit">
                                    <PWButton className="hover-success oi" title={lang.modify} dataGlyph="pencil" onClick={this.callEdit.bind(this, item.banner_id)}>
                                    </PWButton>
                                </td>
                ...
                <dl className="field">
                    ...
                    <dd className="col-5">
                        {pp.edit_type == IEditType.modify ?
                            <FileUpBtn id={pp.field.banner_id} fileKey="banner_list" title="圖片上傳" is_img={true} />
